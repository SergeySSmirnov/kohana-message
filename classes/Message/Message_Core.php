<?php
namespace RUSproj\Kohana\Message\Message;

use RUSproj\Kohana\Message\Message;
use Config_Group, Kohana, Session, Text, View;
 ...
 * @copyright  2014-2019 © Sergey S. Smirnov
 */
class Message_Core
{
    ...
    public static function get(string $type = null) {
        $_selfMess = self::getSession()->get(self::$config['session_key'], []);
